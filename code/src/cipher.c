...
void encrypt(uint8_t* plaintext, uint8_t* ciphertext, int message_length, const uint8_t* key, int keysize) {
...
void decrypt(uint8_t* ciphertext, uint8_t* plaintext, int message_length, const uint8_t* key, int keysize) {
